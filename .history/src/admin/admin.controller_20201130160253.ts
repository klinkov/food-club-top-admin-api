import { Controller, Post, Put, Param, Body, Get, ParseIntPipe } from '@nestjs/common';
...
export class AdminController {
    ...
    @Put(':id')
    async edit(@Param('id', ParseIntPipe) id: number, @Body() body: EditAdminDto) {
        const editedCity = (await this.coreGateway.request<AdminDto>('admin-edit', {
            id,
            ...body
        })).toClass(ManagerDto);
        return editedCity;
